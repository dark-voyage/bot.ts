...
export const help = Markup.inlineKeyboard([[Markup.switchToCurrentChatButton('Search Projects', '')]]);
...
export const check = Markup.inlineKeyboard([Markup.callbackButton(`🔃 Refresh`, `check`)]);

export const form_accept = Markup.inlineKeyboard([[Markup.urlButton(`Community Channel`, `https://t.me/genemators`)]]);

export const form_decline = Markup.inlineKeyboard([[Markup.urlButton(`Feedback Zone`, `https://t.me/genemabot`)]]);

export const form_complete = Markup.inlineKeyboard([
	[Markup.callbackButton(`Completed...`, `respond_complete`)],
	[Markup.urlButton(`Check pending invitations`, `https://github.com/orgs/chiseldevs/people/pending_invitations`)],
	[Markup.urlButton(`Check pending collaborators`, `https://github.com/orgs/chiseldevs/pending_collaborators`)],
]);
...
export const form_admin = (data) =>
	Markup.inlineKeyboard([
		[Markup.callbackButton(`✅`, `accept_form_${data}`), Markup.callbackButton(`❌`, `decline_form_${data}`)],
		[Markup.urlButton(`Check pending invitations`, `https://github.com/orgs/chiseldevs/people/pending_invitations`)],
		[Markup.urlButton(`Check pending collaborators`, `https://github.com/orgs/chiseldevs/pending_collaborators`)],
	]);

export const invalid = Markup.inlineKeyboard([Markup.callbackButton(`Show available commands`, `help`)]);
...
export const audio = Markup.inlineKeyboard([
	[Markup.urlButton(`Upload your own music & audio!`, `https://t.me/genemabot`)],
	[Markup.urlButton(`Community Channel`, `https://t.me/genemators`)],
]);
...
export const error_admin = Markup.inlineKeyboard([Markup.urlButton(`Contact with admin`, `https://t.me/genemator`)]);
...
export const stream = Markup.inlineKeyboard([
	...
	[Markup.urlButton(`YouTube`, `https://www.youtube.com/channel/UCuF2yVTeVW6vcwXobvXXvZg`)],
]);
